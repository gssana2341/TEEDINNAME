        ...
        <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <select className="w-full p-3 bg-gray-200 rounded-md appearance-none pr-10" defaultValue="">
              ...
              <div className="mb-8">
                <h3 className="text-lg font-medium mb-4">ข้อมูลพื้นที่ใช้สอย</h3>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <label className="block text-sm mb-1">พื้นที่ใช้สอย (ตร.ม.)</label>
                    <div className="relative">
                      <select className="w-full p-3 bg-gray-200 rounded-md appearance-none pr-10" defaultValue="">
                        <option value="" disabled>
                          โปรดระบุ
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm mb-1">ห้องนั่งเล่น</label>
                        <Input
                          type="number"
                  ...
                  <div>
                    <label className="block text-sm mb-1">ที่จอดรถ (จำนวนคัน)</label>
                    <div className="relative">
                      <select className="w-full p-3 bg-gray-200 rounded-md appearance-none pr-10" defaultValue="">
                        <option value="" disabled>
                          โปรดระบุ
              ...
              <div className="mb-8">
                ...
                <Textarea placeholder="กรอกรายละเอียด" className="w-full p-3 bg-gray-200 rounded-md min-h-[120px]" />
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  <Input placeholder="โปรดระบุที่ตั้งอสังหาฯ" className="w-full p-3 bg-gray-200 rounded-md pr-10" />
                  <MapPin className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500" size={20} />
                </div>
              </div>

              {/* Submit Button */}
              <Button type="submit" className="w-full bg-[#006ce3] hover:bg-blue-700 text-white py-3 rounded-md">
                ยืนยัน
              </Button>
            </form>
          </div>
